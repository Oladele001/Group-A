                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-300">
                        ...
                        <a href="tel:+2349013065088" className="text-red-400 hover:text-red-300 font-bold">
                          +2349013065088
                        </a>
                      </p>
                      <p className="text-gray-300">
                        <span className="font-semibold">General:</span>{" "}
                        <a href="tel:+2349071036923" className="text-blue-400 hover:text-blue-300">
                          +2349071036923
                        </a>
                      </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-300">
                        ...
                        <a href="mailto:groupanhc@gmail.com" className="text-blue-400 hover:text-blue-300">
                          groupanhc@gmail.com
                        </a>
                      </p>
                      <p className="text-gray-300">
                      ...
                      <p className="text-gray-300">
                        <span className="font-semibold">Emergency:</span>{" "}
                        <a href="mailto:groupanhc@gmail.com" className="text-red-400 hover:text-red-300">
                          groupanhc@gmail.com
                        </a>
                      </p>
                    </div>
